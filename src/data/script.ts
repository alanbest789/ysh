...
export const MOCK_SCRIPT_SECTION: IScriptSection = {
  id: '1',
  title: '剧本开发',
  description: '汇聚行业资深精英编剧，整合全职、签约、合作三位一体的立体化人才矩阵，提供从策划、大纲到成稿的一站式剧本创作服务，覆盖男频、女频全体题材，把控内容节奏、质量与题材风险。',
  buttonText: '进入剧本库',
...
export const MOCK_SCRIPT_HIGHLIGHTS: IScriptHighlight[] = [
  {
    ...
    icon: 'script',
    title: '人才矩阵保障',
    description: '一线实战经验，全职、签约、合作三位一体的立体化人才矩阵'
  },
  {
    id: '2',
    icon: 'star',
    title: '多题材爆款基因',
    description: '头部编剧领航，覆盖悬疑/甜宠/现实/古装等全赛道，不挑题材只出好戏'
  },
  {
    id: '3',
    icon: 'library',
    title: '规范化交付标准',
    description: '规范化审读流程，标签化分类，快速检索'
  }
]
